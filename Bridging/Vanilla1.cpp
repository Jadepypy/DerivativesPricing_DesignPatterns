...
//pass by refernce
//but with bridge pattern all the work is done in PayOffBridge class, with clone, operator= methods implemented and refernce to implemnentation class PayOff
